...
export default function RegisterForm(){
  ...
  return <form className="auth-card" onSubmit={submit}>
    ...
    <label>Pseudo<input name="username" autoComplete="username" minLength={3} maxLength={32} required/></label>
    <label>Mot de passe<input name="password" type="password" autoComplete="new-password" minLength={1} maxLength={128} required/></label>
